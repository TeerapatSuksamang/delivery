        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <form action="food_discount_db.php" class="card shadow p-4" method="post">
                    <h1 class="text-center mb-3">กำหนดส่วนลด (%)</h1>
                    <?php
                    ...
                    <input type="text" class="form-control mb-3" name="food_type" value="<?php echo $row['food_name'] ?>" readonly>
                    ...
                    <input type="text" class="form-control mb-3" name="price" value="<?php echo $row['price'] ?>" readonly>
                    
                    <label for="" class="form-lable">ส่วนลด</label>
                    <input type="text" class="form-control mb-3" name="discount" value="<?php echo $row['discount'] ?>" required>
