...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="hamburger">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="profile.php" class="nav-link active">ข้อมูลร้านอาหาร</a>
                    </li>
                </ul>
    ...
    <div class="container-fluid">
        <h1 class="my-4">ข้อมูลร้านอาหาร</h1>
        <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered shadow text-center">
                ...
                <tr>
                    ...
                    <td>
                        <img src="../upload/<?php echo $row['img']; ?>" class="rounded" style="width: 20vh; height: auto;">
                    </td>
