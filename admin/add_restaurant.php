...
<body>
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <form action="add_restaurant_db.php" class="card shadow p-4" method="post" enctype="multipart/form-data">
                    <h1 class="text-center mb-4">เพิ่มประเภทร้านอาหาร</h1>

                    <label for="" class="form-lable">ชื่อประเภทร้านอาหาร</label>
                    <input type="text" class="form-control mb-3" name="res_type">
